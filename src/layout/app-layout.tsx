...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['school-owner', 'school-administrator', 'teacher', 'student', 'parent', 'school-co-ordinator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Teachers', path: '/teachers', entity: 'teacher', service: AccessServiceEnum.PROJECT, icon: FiFeather },
