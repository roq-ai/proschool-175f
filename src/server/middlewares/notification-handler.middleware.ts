...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'Assignment Submission.update': { roles: ['teacher'], key: 'assignment_submission', tenantPath: [], userPath: [] },
  'Event Scheduling.create': {
    roles: ['school-owner', 'school-administrator', 'teacher', 'student', 'parent', 'school-co-ordinator'],
...
const ownerRoles: string[] = ['school-owner'];
